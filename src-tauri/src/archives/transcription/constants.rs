...
pub const WAV_CHUNK_DURATION: u32 = 8;
pub const WAV_BUFFER_SIZE: usize = (TRANSCRIPTION_DESIRED_HZ * WAV_CHUNK_DURATION) as usize;

pub const AUDIO_CHANNEL_SIZE: usize = 256;
pub const SAMPLED_CHANNEL_SIZE: usize = 1024;
pub const TRANSCRIPTION_CHANNEL_SIZE: usize = 64;
